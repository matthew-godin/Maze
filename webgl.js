...
function initBuffers(gl) {
  ...
  var positions = [];
  {
    ...
    /*cubeOffsetX = 2.0 + bigOffset;
    cubeOffsetZ = 4.0 + bigOffset;
    positions = positions.concat([
          -halfSize + cubeOffsetX, oldHalfSize + cubeOffsetY, -halfSize + cubeOffsetZ,
          halfSize + cubeOffsetX, oldHalfSize + cubeOffsetY, -halfSize + cubeOffsetZ,
          -halfSize + cubeOffsetX, oldHalfSize + cubeOffsetY, halfSize + cubeOffsetZ,
...
function drawScene(gl, programInfo, buffers, texture, deltaTime) {
  ...
  {
    const vertexCount = 30;//36 * mazeWidth * mazeHeight; + 10000;//+ 18 * 8 * mazeWidth * mazeHeight;
  ...
  if (floatCam) {
    ...
    floatQuit = false;
    ZTranslation = 44.0 + 2.0 * mazeHeight;
